...
const InlineEditor: React.FC<InlineEditorProps> = ({ elementHtml, position, onSave, onCancel }) => {
    ...
    return (
        <>
            ...
            <div
                style={editorStyle}
                className="fixed z-50 flex flex-col bg-[var(--card-bg)] backdrop-blur-xl border border-[var(--neon-purple)] rounded-2xl shadow-2xl neon-glow-purple animate-fade-in"
            >
